<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div class="max-w-md" x-data="{ state: $wire.entangle('{{ $getStatePath() }}') }">
        <!-- Interact with the `state` property in Alpine.js -->
        @if (isset($getState()['featuredImage']))
        <div class="aspect-square md:aspect-auto overflow-hidden group">
            <div class="relative p-6" style="height: 448px">
                <img src="{{ $getState()['featuredImage'] }}"
                    style="object-position: {{ $getState()['imagePosition'] }};" alt="Image preview"
